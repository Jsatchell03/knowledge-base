...
function MainContent() {
  const { notes, files, selectedNoteId, selectedFileId, loading, error } = useNotes();
  ...
  return (
    <div className="h-full flex items-center justify-center text-gray-400">
      <div className="text-center">
        ...
        <p className="text-sm">Select a note or file from the sidebar, or create a new one</p>
      </div>
    </div>
  );
}
